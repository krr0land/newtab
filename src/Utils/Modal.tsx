  ...
  return (
    <>
      {props.open && (
        ...
        >
          <div id="window" className="flex flex-col bg-zinc-800 min-w-80 min-h-80 p-4 rounded-xl">
            <div id="titlebar" className="flex  justify-between pb-4">
              <p className="text-2xl">{props.title}</p>
              <button onClick={props.onClose} className="hover:bg-zinc-900 hover:bg-opacity-20 rounded w-8 h-8">
