import { links } from "../Models/config";
  ...
  return (
    <a href={link.url} className="p-3 overflow-hidden block size-fit group">
      <img
        src={link.icon}
        alt={link.title}
        className="w-[180px] h-[120px] m-0 p-0 object-cover border-0 rounded-xl transition-all duration-300 ease-in-out transform-style-3d group-hover:scale-105 group-hover:rotate-[-4deg]"
      />
